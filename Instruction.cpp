...
/*
Instruction::InstructionType Instruction::ParseInstruction Instruction::InstructionType Instruction::ParseInstruction
		
NAME

	Instruction::InstructionType Instruction::ParseInstruction - parse the line

SYNOPSIS

	Instruction::InstructionTpye Instruction::ParseInstruction(string &a_buff);
	
		a_buff --> string which would be parsed, passed by reference

DESCRIPTION

	This function parses a string and returns what kind of an istruction the string is

RETURNS

	This function returns a instruction type based on the string that gets parsed
	if it is a comment, assembler, machine, or end instruction
*/
...
/**/
/*
int Instruction::LocationNextInstruction int Instructtion::LocationNextInstruction

NAME

	int Instruction::LocationNextInstruction - get the next instruction location

SYNOPSIS

	int Instruction::LocationNextInstruction(int a_loc);

		a_loc --> location where the function enters in

DESCRIPTION

	This function takes in the instruction address and returns the address of the next instruction

RETURNS

	This function returns an INT which is the next instruction location depending on the instruction type 
...
int Instruction::LocationNextInstruction(int a_loc) {
	...
	if ((m_type = ParseInstruction(s)) == ST_MachineLanguage && !m_Operand.empty()) {
		if (s.compare("ORG") == 0) {
...
/**/
/*
int Instruction::Translate int Instruction::translate

NAME

	int Instruction::Translate - return the instruction
...
DESCRIPTION
	...
	Function translates location and returns instruction

RETURNS

	This function returns an INT which corresponds to an instruction, if it does not find the instruction
	it returns a number which is out of bounds
*/
int Instruction::Translate() {
